...
static NSString *gKey = @"set_key_here";        //与服务端保持一致
static NSString *gIv = @"setup_gIv_here11";     //与服务端保持一致, 长度必须16位
...
+ (NSString *)AES128Decrypt:(NSString *)encryptedString {
    ...
    NSData *data = [[NSData alloc] initWithBase64EncodedString:encryptedString options:NSDataBase64DecodingIgnoreUnknownCharacters];
